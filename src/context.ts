...
class Context implements ContextInterface {
  ...
  public SCOPES = new AuthScopes([]);
  public HOST_NAME = '';
  public API_VERSION = ApiVersion.Unstable;
  public IS_EMBEDDED_APP = true;
  public IS_PRIVATE_APP = false;
  public SESSION_STORAGE: SessionStorage = new MemorySessionStorage();

  public LOG_FILE?: string | undefined;
  public USER_AGENT_PREFIX?: string | undefined;
  public PRIVATE_APP_STOREFRONT_ACCESS_TOKEN?: string | undefined;

  constructor() {}

  public initialize(params: ContextParams): void {
    let scopes: AuthScopes;
    if (params.SCOPES instanceof AuthScopes) {
      scopes = params.SCOPES;
    } else {
  ...
  public throwIfUninitialized(): void {
    if (!this.API_KEY || this.API_KEY.length === 0) {
      throw new ShopifyErrors.UninitializedContextError(
        'Context has not been properly initialized. Please call the .initialize() method to setup your app context object.',
      );
  ...
  public throwIfPrivateApp(message: string): void {
