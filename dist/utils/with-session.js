...
function withSession(_a) {
    var clientType = _a.clientType, isOnline = _a.isOnline, req = _a.req, res = _a.res, shop = _a.shop, oAuth = _a.oAuth, sessionId = _a.sessionId;
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, load_current_session_1.default(req, res, undefined, oAuth, sessionId)];
                case 1:
                    session = _b.sent();
                    return [3 /*break*/, 4];
                case 2:
                    ...
                    return [4 /*yield*/, load_offline_session_1.default(shop, undefined, oAuth, sessionId)];
                case 3:
                    session = _b.sent();
                    _b.label = 4;
                case 4:
                    ...
                    switch (clientType) {
                        case 'rest':
                            client = new rest_1.RestClient(session.shop, oAuth.context, session.accessToken);
                            return [2 /*return*/, {
                                    client: client,
                                    session: session,
                                }];
                        case 'graphql':
                            client = new graphql_1.GraphqlClient(session.shop, oAuth.context, session.accessToken);
                            return [2 /*return*/, {
                                    client: client,
                                    session: session,
                                }];
