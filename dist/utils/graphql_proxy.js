...
function graphqlProxy(userReq, userRes, oAuth, sessionId) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var session, shopName, token, reqBodyString, promise;
        var _this = this;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, load_current_session_1.default(userReq, userRes, undefined, oAuth, sessionId)];
                case 1:
                    session = _a.sent();
                    if (!session) {
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        client = new graphql_1.GraphqlClient(shopName, oAuth.context, token);
