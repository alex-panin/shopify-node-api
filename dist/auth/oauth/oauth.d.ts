...
declare class ShopifyOAuth {
     ...
     */
    beginAuth(request: http.IncomingMessage, response: http.ServerResponse, shop: string, redirectPath: string, isOnline: boolean | undefined, sessionId: string): Promise<string>;
    /**
