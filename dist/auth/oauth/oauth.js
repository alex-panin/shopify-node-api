...
function validQuery(query, session) {
    return (hmac_validator_1.default(query, session.context) &&
        shop_validator_1.default(query.shop) &&
        safe_compare_1.default(query.state, session.state));
}
var ShopifyOAuth = /** @class */ (function () {
    function ShopifyOAuth(context) {
        this.context = context;
        this.SESSION_COOKIE_NAME = 'shopify_app_session';
    }
    /**
     ...
     */
    ShopifyOAuth.prototype.beginAuth = function (request, response, shop, redirectPath, isOnline, sessionId) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        session = new session_1.Session(isOnline ? uuid_1.v4() : sessionId, this.context);
                        session.shop = shop;
                        session.state = state;
                        session.isOnline = isOnline;
                        return [4 /*yield*/, this.context.SESSION_STORAGE.storeSession(session)];
                    case 1:
     ...
     */
    ShopifyOAuth.prototype.validateAuthCallback = function (request, response, query) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.context.SESSION_STORAGE.loadSession(sessionCookie)];
                    case 1:
                        ...
                        client = new http_client_1.HttpClient(currentSession.shop, this.context);
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 5];
                    case 3:
                        if (!this.context.IS_EMBEDDED_APP) return [3 /*break*/, 5];
                        ...
                        jwtSession = session_1.Session.cloneSession(currentSession, jwtSessionId, this.context);
                        return [4 /*yield*/, this.context.SESSION_STORAGE.storeSession(jwtSession)];
                    case 4:
                        _a.sent();
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this.context.SESSION_STORAGE.storeSession(currentSession)];
                    case 6:
                        sessionStored = _a.sent();
                        if (!sessionStored) {
                            throw new ShopifyErrors.SessionStorageError('OAuth Session could not be saved. Please check your session storage functionality.');
     ...
     */
    ShopifyOAuth.prototype.getCookieSessionId = function (request, response) {
     ...
     */
    ShopifyOAuth.prototype.getJwtSessionId = function (shop, userId) {
     ...
     * @param shop Shopify shop domain
     */
    ShopifyOAuth.prototype.getOfflineSessionId = function (shop) {
     ...
     */
    ShopifyOAuth.prototype.getCurrentSessionId = function (request, response, isOnline) {
        ...
        if (this.context.IS_EMBEDDED_APP) {
            ...
            if (authHeader) {
                ...
                var jwtPayload = decode_session_token_1.default(matches[1], this.context);
