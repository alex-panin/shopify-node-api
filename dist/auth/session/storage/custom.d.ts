...
export declare class CustomSessionStorage implements SessionStorage {
    ...
    context: Context;
    constructor(storeCallback: (session: SessionInterface) => Promise<boolean>, loadCallback: (id: string) => Promise<SessionInterface | Record<string, unknown> | undefined>, deleteCallback: (id: string) => Promise<boolean>, context: Context);
